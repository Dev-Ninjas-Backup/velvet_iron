...
class ProgressBarWidgetThemes extends StatelessWidget {
  const ProgressBarWidgetThemes({super.key});
...
class StepsTextWidgetThemes extends StatelessWidget {
  const StepsTextWidgetThemes({super.key});
  @override
  Widget build(BuildContext context) {
    return Container(
...
class ThemesTitleSection extends StatelessWidget {
  const ThemesTitleSection({super.key});
