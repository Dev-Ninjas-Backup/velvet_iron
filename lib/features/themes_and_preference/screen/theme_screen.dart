...
const List<Color> _themeGradient1 = [
  Color(0xFF310101),
  Color(0xFF550606),
  Color(0xFF310101),
  Color(0xFF550606),
...
const List<Color> _themeGradient2 = [
  Color(0xFF1B0033),
  Color(0xFF35065E),
  Color(0xFF1B0033),
  Color(0xFF35065E),
...
const List<Color> _themeGradient3 = [
  Color(0xFF00027B),
  Color(0xFF292CB7),
  Color(0xFF00027B),
  Color(0xFF00013F),
...
const List<Color> _themeGradient4 = [
  Color(0xFF111C18),
  Color(0xFF1E332C),
  Color(0xFF111C18),
  Color(0xFF1E332C),
    ...
    return Scaffold(
      body: CustomBackground2(
        ...
        child: SafeArea(
          child: Stack(
            children: [
              // Use NestedScrollView with a SliverAppBar like ExerciseScreen
              NestedScrollView(
                headerSliverBuilder:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Themes(
                        ...
                        gradientColors: _themeGradient1,
                      ...
                      Themes(
                        ...
                        gradientColors: _themeGradient2,
                      ...
                      Themes(
                        title: 'Reader',
                        badgeText: 'Unlock 250 xp',
                        gradientColors: _themeGradient3,
                        icon: Image.asset(IconPath.lock),
                      ),
                      const SizedBox(height: 12),
                      Themes(
                        title: 'Gamer',
                        badgeText: 'Unlock 250 xp',
                        gradientColors: _themeGradient4,
                        icon: Image.asset(IconPath.lock),
                      ),
