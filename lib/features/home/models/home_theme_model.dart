...
class HomeThemeModel {
  ...
  static HomeThemeModel adventurerTheme = HomeThemeModel(
    id: 'adventurer',
    name: 'Adventurer',
  ...
  /// Theme 2: Blue theme
  static HomeThemeModel mageTheme = HomeThemeModel(
    id: 'mage',
    name: 'Mage',
    backgroundGradient: const LinearGradient(
  ...
  /// Theme 3: Green theme
  static HomeThemeModel readerTheme = HomeThemeModel(
    id: 'reader',
    name: 'Reader',
    backgroundGradient: const LinearGradient(
  ...
  static HomeThemeModel gamerTheme = HomeThemeModel(
    id: 'gamer',
    name: 'Gamer',
    backgroundGradient: const LinearGradient(
    ...
    progressBarGradient: const LinearGradient(
      colors: [Color(0xFF1C0036), Color(0xFFA855E8)],
      begin: Alignment.bottomCenter,
      end: Alignment.topCenter,
    ),
  ...
  static List<HomeThemeModel> getAllThemes() {
